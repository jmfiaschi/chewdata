#[cfg(not(feature = "psql"))]
fn main() -> Result<(), Box<dyn std::error::Error>> {
    return Err("the psql feature is required for this example. Please enable it in your Cargo.toml file. cargo example EXAMPLE_NAME --features psql".into());
}
