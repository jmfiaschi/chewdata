...
coverage-ut:
	...
	@cargo +nightly tarpaulin --out Xml --verbose --doc --lib --workspace --timeout 1200 -- --test-threads=1

coverage-it: start
coverage-it:
	@cargo install cargo-tarpaulin
	@cargo tarpaulin --out Xml --verbose --tests --workspace --timeout 1200 -- --test-threads=1
